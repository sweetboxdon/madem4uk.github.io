...
echo "<a href=10-kontakti.htm>Вернуться</a>";
exit;
}
...
$tema="$familiya, вам пришел ответ с сайта SweetBox";
...
if ($send == 'true')
{echo "<h2>Спасибо за обращение, $familiya! <br />Ваше сообщение отправлено.</h2><p>Мы вам ответим в течении сегоднящнего дня </p><p><a href=10-kontakti.htm>Выйти</a></p> ";}
