...
echo "<a href=02-kontakt-okno.htm>Вернуться</a>";
exit;
}
...
$tema="$familiya, вам пришел ответ с сайта готовых наборов";
...
if ($send == 'true')
{echo "<h2>Спасибо за обращение, $familiya! <br />Ваше сообщение отправлено.</h2><p>Мы вам ответим в течении сегоднящнего дня </p><p><a href=02-kontakt-okno.htm>Выйти</a></p> ";}
